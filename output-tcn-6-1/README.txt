...
output of those will go to NN
         ...
         / --> window size 10 --> tcn --> \
        /  --> window size 30 --> tcn -->  \
input >-   --> window size 50 --> tcn -->  -> tcn  --> result
        \  --> window size 70 --> tcn -->  /
         \ --> window size 90 --> tcn --> /

each tcn is strip befor dense layer ( input layer, tcn1(12) ,tcn2(6)) and result is concatinated as 2d vector to tcn
...
MAE: 7.469980716705322

R^2: 0.928856372833252

RMSE: 10.511451721191406
